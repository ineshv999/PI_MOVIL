...
export default function EditarPerfilScreen({ navigation }) {
  ...
  return <AppShell navigation={navigation} title="Mi perfil" activeRoute="EditarPerfil"><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <Card><Text style={styles.section}>Datos de acceso</Text><ReadOnly label="USUARIO" value={user?.username} /><ReadOnly label="CORREO ELECTRÓNICO" value={user?.correo} /><ReadOnly label="ROL DEL SISTEMA" value={({ administrador: 'Administrador', auditor: 'Auditor', usuario: 'Usuario' })[user?.rol] || user?.rol} /></Card>
