...
export const endpoints = {
  ...
  uploadMyPhoto: (form) => api('/auth/me/foto', { method: 'POST', body: form }),
  users: () => api('/usuarios'),
  ...
  deleteUser: (id) => api(`/usuarios/${id}`, { method: 'DELETE' }),
  purgeUser: (id) => api(`/usuarios/${id}/purga`, { method: 'DELETE' }),
  ...
  deleteAsset: (id) => api(`/activos/${id}`, { method: 'DELETE' }),
  purgeAsset: (id) => api(`/activos/${id}/purga`, { method: 'DELETE' }),
